using System;
using ResidentalCalc.Crypto;
using ResidentalCalc.Infrastructure.HouseManagementService;
using System.Threading;
using System.Configuration;
using System.Runtime.InteropServices;

namespace ResidentalCalc.Helpers.HelperHouseManagementService
{
    /// <summary>
    ...
    class HelperHouseManagementService
    {
        ...
        /// <summary>
        /// Экспорт договора ресурсоснабжения по идентификатору в ГИС ЖКХ
        /// </summary>
        /// <param name="_orgPPAGUID">
        /// Идентификатор зарегистрированной организации
        /// </param>
        ...
        /// </returns>
        public exportSupplyResourceContractDataResponse GetSupplyResourceContractDataByContractRootGUID(string _orgPPAGUID, string _ContractRootGUID)
        {
            var srvHouseMgmt = new HouseManagementPortsTypeClient();
            srvHouseMgmt.ClientCredentials.UserName.UserName = ConfigurationManager.AppSettings["_login"];
            srvHouseMgmt.ClientCredentials.UserName.Password = ConfigurationManager.AppSettings["_pass"];
            ...
            var reqHouseMgmt = new exportSupplyResourceContractDataRequest
            {
                ...
                exportSupplyResourceContractRequest = new exportSupplyResourceContractRequest
                {
                    ...
                    ItemsElementName = new ItemsChoiceType22[]
                    {
                        ItemsChoiceType22.ContractRootGUID
                    },
                    Items = new object[]
                    {
                        _ContractRootGUID
        ...
        /// </param>
        /// <returns></returns>
        public exportAccountDataResponse GetAccountDataByFiasGuid(string _orgPPAGUID, string _FIASHouseGuid)
        {
            var srvHouseMgmt = new HouseManagementPortsTypeClient();
            srvHouseMgmt.ClientCredentials.UserName.UserName = ConfigurationManager.AppSettings["_login"];
            srvHouseMgmt.ClientCredentials.UserName.Password = ConfigurationManager.AppSettings["_pass"];
        ...
        /// Идентификатор зарегистрированной организации
        /// </param>
        /// <param name="_accountGuid">
        /// Идентификатор ЛС в ГИС ЖКХ
        /// </param>
        /// <returns></returns>
        public exportAccountDataResponse GetAccountDataByAccontGuid(string _orgPPAGUID, string _accountGuid)
        {
            var srvHouseMgmt = new HouseManagementPortsTypeClient();
            srvHouseMgmt.ClientCredentials.UserName.UserName = ConfigurationManager.AppSettings["_login"];
            srvHouseMgmt.ClientCredentials.UserName.Password = ConfigurationManager.AppSettings["_pass"];
        ...
        /// </param>
        /// <returns></returns>
        public exportAccountIndividualServicesResponse GetAccountIndividualServices(string _orgPPAGUID, string _accountGUID)
        {
            var srvHouseMgmt = new HouseManagementPortsTypeClient();
            srvHouseMgmt.ClientCredentials.UserName.UserName = ConfigurationManager.AppSettings["_login"];
            srvHouseMgmt.ClientCredentials.UserName.Password = ConfigurationManager.AppSettings["_pass"];

            var reqAccountIndividualServices = new exportAccountIndividualServicesRequest1
            {
                RequestHeader = new RequestHeader
                {
                    Date = DateTime.Now,
                ...
                exportAccountIndividualServicesRequest = new exportAccountIndividualServicesRequest
                {
                    version = "11.0.0.1",
                    //Id = CryptoConsts.CONTAINER_ID,
                    ItemsElementName = new ItemsChoiceType25[]
                    {
                        ItemsChoiceType25.AccountGuid
                    },
                    Items = new string[]
                    {
                        _accountGUID
            ...
            exportAccountIndividualServicesResponse resHouseMgmt = null;
            do
            {
                try
                {
                    resHouseMgmt = srvHouseMgmt.exportAccountIndividualServices(reqAccountIndividualServices);
                }
                catch (Exception e)
                {
                    Console.ForegroundColor = ConsoleColor.Red;
